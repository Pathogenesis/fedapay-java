...
public class All {
	...
	public static String allRequestJsonResponse;

	public static <T> T all(T cls, String serviceUrl) throws Exception {

		Request request = new Request.Builder().url(UrlMaker.getUrl(serviceUrl))
				.addHeader("Authorization", "Bearer " + FedaPay.apiKey).addHeader("Content-Type", "application/json")
		...
		if (response.isSuccessful()) {
			allRequestJsonResponse = responseString;
